          ...
          <div className="bg-gray-800/90 rounded-lg p-6 border border-gray-700 backdrop-blur-sm max-w-4xl mx-auto">
            <div className="flex flex-col items-center">
              {frameworkItems.map((item, index) => {
                const marginClass = index === 0 ? "ml-[95px] -mt-5" : index === 1 ? "ml-[5px] -mt-[135px]" : index === 2 ? "-ml-[105px] -mt-[190px]" : index === 3 ? "-ml-[90px] -mt-[187px]" : index === 4 ? "-ml-[60px] -mt-[80px]" : "-mt-20";
                const topMargin = "";
                return (
                  <div 
                    key={index}
                  ...
                  >
                    ...
                    >
                    <div className={`relative z-10 h-full flex flex-col ${index === 1 ? 'justify-center -mt-2' : 'justify-center'} ${index === 1 ? 'max-w-[350px]' : 'max-w-[500px]'} mx-auto`}>
                      <div className="mb-4">
