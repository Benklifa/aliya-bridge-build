                ...
                {frameworkSections.map((section, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <div className={`relative z-10 h-full flex flex-col ${index === 1 ? 'justify-center -mt-2' : 'justify-center'} ${index === 1 ? 'max-w-[350px]' : 'max-w-[500px]'} mx-auto ${index === 0 ? '-mt-6 ml-2.5' : ''}`}>
                          <div className="mb-4">
